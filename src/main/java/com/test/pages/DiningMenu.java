...
public class DiningMenu extends ICSStoreMenu{
    ...
    public DiningMenu addDiningSection(String sectionName, String  imageName){
    ...
    public DiningSubmenu gotoDiningMenu (String sectionName){
