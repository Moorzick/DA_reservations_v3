...
public class mockPMSAutomated extends BaseTest {
    ...
    private final String affiliate = "-INTELITY Hotel-"; //"QA Base" Intelity Hotel "-Prod Halyna\'s Hotel-"
    ...
    private final String phoneNumber = "+380687764928";
    ...
    public void automated() throws Throwable {
